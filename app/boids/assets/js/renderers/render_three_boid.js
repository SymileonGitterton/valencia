...
var canvas = document.getElementById("three_boid");	//PMA step 5
...
var controls = new THREE.OrbitControls(camera,canvas); //PMA step 5: originally only 'camera' argument
...
//PMA step 5 document.body.appendChild(stats.domElement);
...
stats.domElement.style.float = 'right';	// PMA step 5
...
var gui = new dat.GUI();
document.getElementById('dat_gui_container').appendChild(gui.domElement);	//PMA step 5
